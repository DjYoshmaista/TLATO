...
repo_mgr = RepoManager(base_directory=DATA_REPO_DIR, metadata_filename=INDEX_FILE.name, progress_dir_name=PROGRESS_DIR, create_if_missing=True, index_filename=INDEX_FILENAME, max_workers=MAX_WORKERS)
